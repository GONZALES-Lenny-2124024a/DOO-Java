 ...
 */
public class ArithmeticTest1 {    // Save as "ArithmeticTest1.java"
   public static void main(String[] args) {
      ...
      // Print results
      System.out.print("The sum, difference, product, quotient and remainder of " + number1 + " and " + number2 + " are " + sum + ", " + difference + ", " + product + ", " + quotient + ", and " + remainder);  // Print descriptions and values
